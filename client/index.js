...
// Parse incoming JSON request bodies so req.body works in our route handlers
...
// after the connection succeeds. This prevents the API from receiving
// requests before it can talk to the database.
